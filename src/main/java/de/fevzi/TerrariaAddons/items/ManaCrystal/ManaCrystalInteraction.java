...
public class ManaCrystalInteraction extends SimpleInstantInteraction {
    ...
    public static final BuilderCodec<ManaCrystalInteraction> CODEC = BuilderCodec.builder(ManaCrystalInteraction.class, ManaCrystalInteraction::new, SimpleInstantInteraction.CODEC).build();
